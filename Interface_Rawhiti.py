...
class SpectrogramInterface(QMainWindow):
    ...
    def createFrame(self):
        ...
        self.w_controls.addWidget(self.dragRectangles,row=2,col=4)
        self.w_controls.addWidget(self.useAmplitudeTick,row=2,col=5)
        ...
        #for w in [deleteButton,deleteAllButton,denoiseButton, spectrogramButton,segmentButton, findMatchButton, checkButton1, checkButton2, dockButton, quitButton, loadButton, playSegButton]:
        for w in [loadButton,deleteButton,deleteAllButton,spectrogramButton,segmentButton,denoiseButton, dockButton, quitButton]:

...
class Segmentation(QDialog):
    ...
    def __init__(self, maxv, DOC=False, species=None, parent=None):
        ...
        self.minlen.setTickInterval(0.025*1000)
        self.minlen.setRange(0.01*1000, 3*1000)
        self.minlen.setSingleStep(0.25*100)
        self.minlen.setValue(0.2*100)
        self.minlen.valueChanged.connect(self.minLenChange)
        self.minlenlbl = QLabel("Minimum segment length: 0.02 sec")

        self.maxgap = QSlider(Qt.Horizontal)
        self.maxgap.setTickPosition(QSlider.TicksBelow)
        self.maxgap.setTickInterval(0.025*1000)
        self.maxgap.setRange(0.01*1000, 3*1000)
        self.maxgap.setSingleStep(0.01*100)
        self.maxgap.setValue(0.01*100)
        self.maxgap.valueChanged.connect(self.maxGapChange)
        self.maxgaplbl = QLabel("Maximum gap between syllables: 0.01 sec")

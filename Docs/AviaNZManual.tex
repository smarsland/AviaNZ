...
\begin{itemize}
\item Classification is done by species, but with the option to also choose a call type.
\item To classify a segment go to the species name in the drop-down menu. This will then open a submenu for the call type. Select it by clicking the right label, or `Not Specified' if you don't know.
...
\item If you click anywhere on the screen except on a call name in the menu then the menu will disappear and the bird type will be labelled as `Don't Know'. 
\item To clear the labels for a segment you can also just click `Don't Know'.

...
\item The button below them (with a picture of a snail on it) lets you play back the selected segment at different speeds. The choice of speed is in the `Appearance' menu under `Playback speed'. Note that this changes the pitch of the sound.
...
\item [Playback speed] Choose the speed at which the snail button in the Controls area plays back the sound file.
\end{description}

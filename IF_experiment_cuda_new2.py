...
This program implements the experiment pipeline for the IF extraction for testing normalisation techniques
...
def find_optimal_spec_IF_parameters(test_param, op_param, op_m, file_dir, wav_file_list, csv_path, f_names,
    ...
    for signal_file in wav_file_list:
        ...
        if normal_type != "Standard":
            tfr = sp.normalisedSpec(tr=normal_type)
...
def calculate_metrics_original_signal(signal_dir, save_dir, sign_id, sg_type, sg_scale, sg_norm, opt_param):
    ...
    # spectrogram normalizations
    if sg_norm != "Standard":
        tfr = sp.normalisedSpec(tr=sg_norm)
    ...
    # spectrogram normalizations
    if sg_norm != "Standard":
        tfr_inv = sp.normalisedSpec(tr=sg_norm)
...
main_results_dir = '/am/state-opera/home1/listanvirg/Documents/IF_experiment_Results_New'
...
optimization_metrics = ['Curve_registration']
# optimization options
optimization_options = ["Directory"]
                ...
                for opt_option in optimization_options:
                    ...
                    for signal_id in os.listdir(dataset_dir):
                        ...
                        if norm_type != "Standard":
                            TFR_0 = sp.normalisedSpec(tr=norm_type)
                        ...
                        for noise_dir in noise_levels_folders:
                            ...
                            for file in os.listdir(sig_dataset_path + "/" + noise_dir):
                                ...
                                # spectrogram normalizations
                                if norm_type != "Standard":
                                    TFR_inv = sp.normalisedSpec(tr=norm_type)

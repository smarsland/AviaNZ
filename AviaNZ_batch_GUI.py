...
class AviaNZ_reviewAll(QMainWindow):
    ...
    def createFrame(self):
        ...
        self.d_detection.addWidget(minCertLab, row=2, col=0)
        self.d_detection.addWidget(self.certBox, row=2, col=1)
        self.d_detection.addWidget(self.fLowtext, row=3, col=0)
        self.d_detection.addWidget(self.fLow, row=3, col=1)
        self.d_detection.addWidget(self.fLowvalue, row=3, col=2)
        self.d_detection.addWidget(self.fHightext, row=4, col=0)
        self.d_detection.addWidget(self.fHigh, row=4, col=1)
        self.d_detection.addWidget(self.fHighvalue, row=4, col=2)
        self.d_detection.addWidget(QLabel("FFT window size"), row=5, col=0)
        self.d_detection.addWidget(self.winwidthBox, row=5, col=1)
        self.d_detection.addWidget(QLabel("FFT hop size"), row=6, col=0)
        self.d_detection.addWidget(self.incrBox, row=6, col=1)
        ...
        self.d_detection.addWidget(self.w_speLabel1,row=11,col=0)
        self.d_detection.addWidget(self.w_spe1,row=11,col=1,colspan=1)
        ...
        self.d_detection.addWidget(self.w_processButton, row=9, col=2)
        linesep = QFrame()
        linesep.setFrameShape(QFrame.HLine)
        linesep.setFrameShadow(QFrame.Sunken)
        self.d_detection.addWidget(linesep, row=10, col=0, colspan=3)
        self.d_detection.addWidget(self.w_processButton1, row=11, col=2)

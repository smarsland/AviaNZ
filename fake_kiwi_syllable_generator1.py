...
if n == 1:
    ...
    if syllable_type == 'A':
        if_t = Syllable_IF_fun1(t, t0, t1, t2, f0, f1, f2)
        phi_t = Syllable_phase_fun1(t, t0, t1, t2, f0, f1, f2, phi, samplerate)
    else:
        if_t = Syllable_IF_fun2(t, t0, t1, t2, f0, f1, f2)
        phi_t = Syllable_phase_fun2(t, t0, t1, t2, f0, f1, f2, phi, samplerate)
    ...
    signal = Amplitude_base * np.sin(phi + phi_t)

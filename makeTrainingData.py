...
dir = "D:\Desktop\Documents\Work\Data\Bat\BAT\CNN experiment\TEST" #changed direcotìry
species = None
fs = 16000
dataset = []
...
#   considering just the center of the syllable for bats    
    win = 0.25
...
##        print(rest)
#    rest2= rest/2
#    start=  record[2][0]  + rest2
#    end= record[2][1] - rest2
#    audiodata = loadFile(filename=record[0], duration=win, offset=start, fs=fs, denoise=False, f1=0, f2=0)
#    audiodata = audiodata.tolist()
#    sp.data = audiodata
#    sp.sampleRate = fs

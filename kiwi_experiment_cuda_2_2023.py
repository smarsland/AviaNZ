...
This is an experiment script testing different parameter for a reassigned spectrogram with linear scale
...
for norm_type in norm_list:
    ...
    if norm_type == "Standard":
        ...
        window_parameters_list = [[512, 460], [512, 256], [256, 230], [256, 128]]
        Iatsenko_parameters_list = [[0.5, 0], [7.5, 0.5], [5, 0], [5, 0.5], [2.5, 0.5]]
        window_type_list = ["Hann", "Welch", 'Hamming', 'Blackman']
        ...
        for window_parameters in window_parameters_list:
            ...
            for mel_num in mel_list:
                ...
                for Iatsenko_parameters in Iatsenko_parameters_list:
                    ...
                    train_extracted_IF = np.zeros((30, 40000, 2)) # we already know that we have 30 train file,

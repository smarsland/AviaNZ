...
the best 3 in  4different plots: LT, ST, NT, BT
...
print('check NT_ST_best3mean')
print('max', max(NT_ST_best3mean))      
##clicks in BT files    
...
LT_LT_detected_best3mean=np.where(LT_LT_best3mean*100>70,1,0)
LT_LT_detected_max=np.where(LT_LT_max*100>70,1,0)
LT_LT_detected_mean=np.where(LT_LT_mean*100>70,1,0)
#detect ST in LT files
LT_ST_detected_best3mean=np.where(LT_ST_best3mean*100>70,1,0)
LT_ST_detected_max=np.where(LT_ST_max*100>70,1,0)
LT_ST_detected_mean=np.where(LT_ST_mean*100>70,1,0)
#detect BT in LT files
LT_BT_detected_best3mean=np.zeros(np.shape(LT_LT_detected_best3mean))
LT_BT_detected_best3mean[np.nonzero(LT_LT_detected_best3mean==0)]=np.where(LT_LT_best3mean[np.nonzero(LT_LT_detected_best3mean==0)]*100>50 ,1,0)
LT_BT_detected_best3mean[np.nonzero(LT_ST_detected_best3mean==0)]=np.where(LT_ST_best3mean[np.nonzero(LT_ST_detected_best3mean==0)]*100>50 ,1,0)
LT_BT_detected_max=np.zeros(np.shape(LT_LT_detected_max))
LT_BT_detected_max[np.nonzero(LT_LT_detected_max==0)]=np.where(LT_LT_max[np.nonzero(LT_LT_detected_max==0)]*100>50,1,0)
LT_BT_detected_max[np.nonzero(LT_ST_detected_max==0)]=np.where(LT_ST_max[np.nonzero(LT_ST_detected_max==0)]*100>50,1,0)
LT_BT_detected_mean=np.zeros(np.shape(LT_LT_detected_mean))
LT_BT_detected_mean[np.nonzero(LT_LT_detected_mean==0)]=np.where(LT_LT_mean[np.nonzero(LT_LT_detected_mean==0)]*100>50,1,0)
LT_BT_detected_mean[np.nonzero(LT_ST_detected_mean==0)]=np.where(LT_ST_mean[np.nonzero(LT_ST_detected_mean==0)]*100>50,1,0)
...
LT_NT_detected_best3mean=np.where(LT_NT_detected_best3mean>0,1,0)
...
for ax in axes.flat:
    ax.label_outer()
#plt.show()
plt.savefig("D:\\Desktop\\Documents\\Work\\Data\\Bat\\BAT\\CNN experiment\\TEST2\\BAT SEARCH TESTS\\Test_79\\study3\\Test01\\LT_detections.png")

#save
f= open('D:\\Desktop\\Documents\\Work\\Data\\Bat\\BAT\\CNN experiment\\TEST2\\BAT SEARCH TESTS\\Test_79\\study3\\Test01\\LT_missed.txt', 'w')
f.write('BEST 3 MEAN \n')
...
ST_LT_detected_best3mean=np.where(ST_LT_best3mean*100>70,1,0)
ST_LT_detected_max=np.where(ST_LT_max*100>70,1,0)
ST_LT_detected_mean=np.where(ST_LT_mean*100>70,1,0)
#detect ST in ST files
ST_ST_detected_best3mean=np.where(ST_ST_best3mean*100>70,1,0)
ST_ST_detected_max=np.where(ST_ST_max*100>70,1,0)
ST_ST_detected_mean=np.where(ST_ST_mean*100>70,1,0)
#detect BT in ST files
ST_BT_detected_best3mean=np.zeros(np.shape(ST_ST_detected_best3mean))
ST_BT_detected_best3mean[np.nonzero(ST_LT_detected_best3mean==0)]=np.where(ST_LT_best3mean[np.nonzero(ST_LT_detected_best3mean==0)]*100>50 ,1,0)
ST_BT_detected_best3mean[np.nonzero(ST_ST_detected_best3mean==0)]=np.where(ST_ST_best3mean[np.nonzero(ST_ST_detected_best3mean==0)]*100>50 ,1,0)
ST_BT_detected_max=np.zeros(np.shape(ST_ST_detected_max))
ST_BT_detected_max[np.nonzero(ST_LT_detected_max==0)]=np.where(ST_LT_max[np.nonzero(ST_LT_detected_max==0)]*100>50,1,0)
ST_BT_detected_max[np.nonzero(ST_ST_detected_max==0)]=np.where(ST_ST_max[np.nonzero(ST_ST_detected_max==0)]*100>50,1,0)
ST_BT_detected_mean=np.zeros(np.shape(ST_LT_detected_mean))
ST_BT_detected_mean[np.nonzero(ST_LT_detected_mean==0)]=np.where(ST_LT_mean[np.nonzero(ST_LT_detected_mean==0)]*100>50,1,0)
ST_BT_detected_mean[np.nonzero(ST_ST_detected_mean==0)]=np.where(ST_ST_mean[np.nonzero(ST_ST_detected_mean==0)]*100>50,1,0)
#Detected NT in LT files
...
ST_NT_detected_best3mean=np.where(ST_NT_detected_best3mean>0,1,0)
...
ST_NT_detected_max=np.where(ST_NT_detected_max>0,1,0)
...
ST_NT_detected_mean=np.where(ST_NT_detected_mean>0,1,0)

## find missed LT files with different methods
# a missed file is a file that  it will be classified as noise

ST_filenames_a=np.reshape(ST_filenames,(len(ST_filenames),1))
ST_missed_best3mean=LT_filenames_a[np.nonzero(ST_NT_detected_best3mean)]
...
for ax in axes.flat:
    ax.label_outer()
#plt.show()
plt.savefig("D:\\Desktop\\Documents\\Work\\Data\\Bat\\BAT\\CNN experiment\\TEST2\\BAT SEARCH TESTS\\Test_79\\study3\\Test01\\ST_detections.png")

#save
f= open('D:\\Desktop\\Documents\\Work\\Data\\Bat\\BAT\\CNN experiment\\TEST2\\BAT SEARCH TESTS\\Test_79\\study3\\Test01\\ST_missed.txt', 'w')
f.write('BEST 3 MEAN \n')
...
NT_LT_detected_best3mean=np.where(NT_LT_best3mean*100>70,1,0)
NT_LT_detected_max=np.where(NT_LT_max*100>70,1,0)
NT_LT_detected_mean=np.where(NT_LT_mean*100>70,1,0)
#detect ST in NT files
NT_ST_detected_best3mean=np.where(NT_ST_best3mean*100>70,1,0)
NT_ST_detected_max=np.where(NT_ST_max*100>70,1,0)
NT_ST_detected_mean=np.where(NT_ST_mean*100>70,1,0)
#detect BT in NT files
NT_BT_detected_best3mean=np.zeros(np.shape(NT_LT_detected_best3mean))
NT_BT_detected_best3mean[np.nonzero(NT_LT_detected_best3mean==0)]=np.where(NT_LT_best3mean[np.nonzero(NT_LT_detected_best3mean==0)]*100>50 ,1,0)
NT_BT_detected_best3mean[np.nonzero(NT_ST_detected_best3mean==0)]=np.where(NT_ST_best3mean[np.nonzero(NT_ST_detected_best3mean==0)]*100>50 ,1,0)
NT_BT_detected_max=np.zeros(np.shape(NT_LT_detected_max))
NT_BT_detected_max[np.nonzero(NT_LT_detected_max==0)]=np.where(NT_LT_max[np.nonzero(NT_LT_detected_max==0)]*100>50,1,0)
NT_BT_detected_max[np.nonzero(NT_ST_detected_max==0)]=np.where(NT_ST_max[np.nonzero(NT_ST_detected_max==0)]*100>50,1,0)
NT_BT_detected_mean=np.zeros(np.shape(NT_LT_detected_mean))
NT_BT_detected_mean[np.nonzero(NT_LT_detected_mean==0)]=np.where(NT_LT_mean[np.nonzero(NT_LT_detected_mean==0)]*100>50,1,0)
NT_BT_detected_mean[np.nonzero(NT_ST_detected_mean==0)]=np.where(NT_ST_mean[np.nonzero(NT_ST_detected_mean==0)]*100>50,1,0)
...
NT_NT_detected_best3mean=np.where(NT_NT_detected_best3mean>0,1,0)
...
NT_NT_detected_max=np.where(NT_NT_detected_max>0,1,0)
...
NT_NT_detected_mean=np.where(NT_NT_detected_mean>0,1,0)
...
for ax in axes.flat:
    ax.label_outer()
#plt.show()
plt.savefig("D:\\Desktop\\Documents\\Work\\Data\\Bat\\BAT\\CNN experiment\\TEST2\\BAT SEARCH TESTS\\Test_79\\study3\\Test01\\NT_detections.png")

##BT files plot

#detect LT in BT files
BT_LT_detected_best3mean=np.where(BT_LT_best3mean*100>70,1,0)
BT_LT_detected_max=np.where(BT_LT_max*100>70,1,0)
BT_LT_detected_mean=np.where(BT_LT_mean*100>70,1,0)
#detect ST in BT files
BT_ST_detected_best3mean=np.where(BT_ST_best3mean*100>70,1,0)
BT_ST_detected_max=np.where(BT_ST_max*100>70,1,0)
BT_ST_detected_mean=np.where(BT_ST_mean*100>70,1,0)
#detect BT in BT files
BT_BT_detected_best3mean=np.zeros(np.shape(BT_LT_detected_best3mean))
BT_BT_detected_best3mean[np.nonzero(BT_LT_detected_best3mean==0)]=np.where(BT_LT_best3mean[np.nonzero(BT_LT_detected_best3mean==0)]*100>50 ,1,0)
BT_BT_detected_best3mean[np.nonzero(BT_ST_detected_best3mean==0)]=np.where(BT_ST_best3mean[np.nonzero(BT_ST_detected_best3mean==0)]*100>50 ,1,0)
BT_BT_detected_max=np.zeros(np.shape(BT_LT_detected_max))
BT_BT_detected_max[np.nonzero(BT_LT_detected_max==0)]=np.where(BT_LT_max[np.nonzero(BT_LT_detected_max==0)]*100>50,1,0)
BT_BT_detected_max[np.nonzero(BT_ST_detected_max==0)]=np.where(BT_ST_max[np.nonzero(BT_ST_detected_max==0)]*100>50,1,0)
BT_BT_detected_mean=np.zeros(np.shape(BT_LT_detected_mean))
BT_BT_detected_mean[np.nonzero(BT_LT_detected_mean==0)]=np.where(BT_LT_mean[np.nonzero(BT_LT_detected_mean==0)]*100>50,1,0)
BT_BT_detected_mean[np.nonzero(BT_ST_detected_mean==0)]=np.where(BT_ST_mean[np.nonzero(BT_ST_detected_mean==0)]*100>50,1,0)
...
BT_NT_detected_best3mean=np.where(BT_NT_detected_best3mean>0,1,0)
...
BT_NT_detected_max=np.where(BT_NT_detected_max>0,1,0)
...
BT_NT_detected_mean=np.where(BT_NT_detected_mean>0,1,0)
...
for ax in axes.flat:
    ax.label_outer()
#plt.show()
plt.savefig("D:\\Desktop\\Documents\\Work\\Data\\Bat\\BAT\\CNN experiment\\TEST2\\BAT SEARCH TESTS\\Test_79\\study3\\Test01\\BT_detections.png")

#save
f= open('D:\\Desktop\\Documents\\Work\\Data\\Bat\\BAT\\CNN experiment\\TEST2\\BAT SEARCH TESTS\\Test_79\\study3\\Test01\\BT_missed.txt', 'w')
f.write('BEST 3 MEAN \n')

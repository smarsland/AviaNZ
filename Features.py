...
class Features:
    ...
    def __init__(self, data=[], sampleRate=0, window_width=256, incr=128):
        ...
        self.sg = sp.spectrogram(sgType='Standard',sgNorm='Log',window_width=self.window_width,incr=self.incr,window='Ones')
        self.sg = self.sg**2
    ...
    def setNewData(self,data,sampleRate):
        ...
        self.data = data
        self.sampleRate = sampleRate
        self.sg = sp.spectrogram(data, sgType='Standard',sgNorm='Log',window_width=self.window_width,incr=self.incr,window='Ones')
...
def testFeatures():
    ...
    #sg = sg ** 2
    sg = sp.spectrogram(data, sgType='Standard',sgNorm='Log', window_width=256, incr=128, window='Hann')

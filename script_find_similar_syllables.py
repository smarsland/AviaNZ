...
results_directory = "C:\\Users\\Virginia\\Documents\\Work\\Individual recognition\\Kiwi_IndividualID\\" \
                    "Kiwi_IndividualID\\exemplars\\Smaller_Dataset\\Tests_results\\Test6"
...
original_directory = "C:\\Users\\Virginia\\Documents\\Work\\Individual recognition\\Kiwi_IndividualID\\" \
                     "Kiwi_IndividualID\\exemplars\\Smaller_Dataset\\Original"
#
...
fake_directory = "C:\\Users\\Virginia\\Documents\\Work\\Individual recognition\\Kiwi_IndividualID\\" \
                     "Kiwi_IndividualID\\exemplars\\Smaller_Dataset\\Original"
...
# fieldnames = ['Syllable', 'First', 'Second', 'Third', 'Fourth']
fieldnames = ['Syllable']
...
with open(csvfilename, 'w', newline='') as csvfile:
    ...
    #                      'Fourth': fake_syllables[indices[3]]})

    for i in range(len(list_syllables)):
        distances = G_dist[i, :]
        indices = np.argsort(distances)[:]
        dictionary = {'Syllable': list_syllables[i]}

        for j in range(1, len(list_syllables)):
            dictionary[fieldnames[j]] = fake_syllables[indices[j]]

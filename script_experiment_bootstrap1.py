...
#################################################        MAIN             ################################
pipeline_list = ["Original", "Smoothed", "Cutted", "Cutted_smoothed"]

dataset_main = "C:\\Users\\Virginia\\Documents\\Work\\Individual recognition\\Kiwi_IndividualID\\exemplars\\" \
                   "Smaller_Dataset2"

# save labels
results_directory = "C:\\Users\\Virginia\\Documents\\Work\\Individual recognition\\Kiwi_IndividualID\\exemplars\\" \
                    "Smaller_Dataset2\\Bootstrap_tests"
...
for pipeline in pipeline_list:
    ...
    for k in range(5):
        ...
        datasets_list_path = dataset_main + "\\Test_50_50_"+str(k)

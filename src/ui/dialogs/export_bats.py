...
from PyQt6.QtWidgets import QLabel, QDialog, QPushButton, QLineEdit, QHBoxLayout, QVBoxLayout, QFormLayout # listing some explicitly to make syntax checks lighter

...
Here we want to produce plot to compare results obtained with 6 different TFR: Standard linear, Standard Mel, Reassignment Linear,
Reassigned Mel
...
def level_significance_plot(dataset, save_fig_name, label_list, plot_t):
    ...
    # Level1
        pc = spost.posthoc_conover(dataset[:, level, :].T, p_adjust = 'holm')
        # pc = spost.posthoc_mannwhitney(dataset[:, level, :].T, p_adjust = 'bonferroni')
    ...
    # fig.savefig(save_fig_name[:-4]+'2.jpg', dpi=200)
...
# test_analysis_dir = "C:\\Users\\Virginia\\Documents\\Work\\Thesis_images\\Chapter_4\\Normalisation\\Standard_Linear"
# test_analysis_dir = "C:\\Users\\Virginia\\Documents\\Work\\Thesis_images\\Chapter_4\\Normalisation\\Standard_Mel"
# test_analysis_dir = "C:\\Users\\Virginia\\Documents\\Work\\Thesis_images\\Chapter_4\\Normalisation\\Reassigned_Linear"
# test_analysis_dir = "C:\\Users\\Virginia\\Documents\\Work\\Thesis_images\\Chapter_4\\Normalisation\\Reassigned_Mel"
# test_analysis_dir = "C:\\Users\\Virginia\\Documents\\Work\\Thesis_images\\Chapter_4\\Normalisation\\Multitapered_Linear"
test_analysis_dir = "C:\\Users\\Virginia\\Documents\\Work\\Thesis_images\\Chapter_4\\Normalisation\\Multitapered_Mel"
...
for i in range(5):
    if i==3:
        continue
    test_list0.append('Test_' + str(start_index + i))
...
# plot_titles = ['Standard Lin.', 'Standard Mel.', 'Reassigned Lin.', 'Reassigned Mel.', 'Multitapered Lin.', 'Multitapered Mel.']
...
fig, ax = plt.subplots(2, method_number, figsize=(25,10))
# boxprops = dict(color='mediumorchid')
# flierprops = dict(markeredgecolor='mediumorchid')
# whiskerprops = dict(color='mediumorchid')
# capprops = dict(color='mediumorchid')
# medianprops = dict(color='rebeccapurple')
# median_color = 'fuchsia'

# boxprops = dict(color='darkmagenta')
...
# flierprops = dict(markeredgecolor='seagreen')
...
flierprops = dict(markeredgecolor='darkgreen')
...
fig, ax = plt.subplots(3, method_number, figsize=(25, 15))
# boxprops = dict(color='mediumorchid')
# flierprops = dict(markeredgecolor='mediumorchid')
# whiskerprops = dict(color='mediumorchid')
# capprops = dict(color='mediumorchid')
...
fig, ax = plt.subplots(4, method_number, figsize=(25, 25))
# boxprops = dict(color='mediumorchid')
# flierprops = dict(markeredgecolor='mediumorchid')
# whiskerprops = dict(color='mediumorchid')
# capprops = dict(color='mediumorchid')
...
fig.suptitle('Signal inversion metrics', fontsize=25)
# fig.tight_layout()

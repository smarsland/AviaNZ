...
def File_label_1(predictions, thr1, thr2, dir_2_save, bmpfile):
    ...
    if num_clicks>=4:
        ...
        if click_detected_flag:
            ...
            # ASSESSING FILE LABEL
            hasST = ST_best3mean>=thr2
            hasLT = LT_best3mean>=thr2
            hasSTlow =ST_best3mean>thr1
            hasLTlow = LT_best3mean>thr1
                ...
                for root, dirs, files in os.walk(dir_path):
                    ...
                    for file in files:
                        ...
                        if file.endswith('.bmp'):
                            ...
                            confusion_matrix= update_confusion_matrix(test_sub_dir, bat_dir[-8:], file, assigned_label, GT_label , confusion_matrix, LT_check, ST_check, thr_check)

...
Here we want to produce plot to compare results obtained with different optimization methods
...
test_list1 = []
for i in range(method_number):
    test_list1.append('Test_' + str(start_index + i))

start_index = 60
test_list2 = []
for i in range(method_number):
    test_list2.append('Test_' + str(start_index + i))

start_index = 90
test_list3 = []
for i in range(method_number):
    test_list3.append('Test_' + str(start_index + i))

start_index = 120
test_list4 = []
for i in range(method_number):
    test_list4.append('Test_' + str(start_index + i))

start_index = 150
test_list5 = []
for i in range(method_number):
    test_list5.append('Test_' + str(start_index + i))
...
fig, ax = plt.subplots(4, method_number, figsize=(25, 20))
boxprops = dict(color='orangered')
flierprops = dict(markeredgecolor='orangered')

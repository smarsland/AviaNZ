...
def testWavelet(dName, species, withzeros, savedetections):
    ...
    window= 1
    inc=None
    Segments, TP, FP, TN, FN = ws.waveletSegment_test(dirName=dName, sampleRate=None, spInfo=speciesData, d=False, f=True, withzeros=withzeros, savedetections=savedetections, window=window, inc=None)

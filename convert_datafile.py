...
################### Time shift ###################################
dirName='D:\\Desktop\\Documents\\Work\\Zohara files\\TEST\\Spectrogram_appearence'
# samplerate1=8000
# samplerate2=4000
# k=samplerate1/samplerate2
win_len=256
hop=128
SampleRate=8000
win_len_sec=win_len/SampleRate
hop_sec=hop/SampleRate
temp_shift=hop_sec
            ...
            with open(annotation_file) as f2:
                ...
                for seg in segments:
                    ...
                    if "Operator" in seg:
                        ...
                        seg[1] = seg[1]-temp_shift
                    else:
                        #print(seg[0])
                        seg[0]=seg[0]-temp_shift
                        #print(seg[0])
                        seg[1] = seg[1]-temp_shift
            new_annotation_file=annotation_file[:-9]+'_tempshift'+str(temp_shift)+'.wav.data'
            with open(new_annotation_file, 'w') as f2:
                json.dump(segments,f2)
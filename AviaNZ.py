...
# Code for drawing and using the main figure
    ...
    def drawfigMain(self,remaking=False):
        ...
        if self.cheatsheet:
            # Complete me!
            offset=4
            self.label1 = pg.TextItem(text=str(0), color='g', anchor=(0,0))
            self.p_spec.addItem(self.label1)
            self.label1.setPos(0,0+offset)

            self.label2 = pg.TextItem(text=str(FreqRange//4000), color='g', anchor=(0,0))
            self.p_spec.addItem(self.label2)
            self.label2.setPos(0,SpecRange/4+offset)

            self.label3 = pg.TextItem(text=str(FreqRange//2000), color='g', anchor=(0,0))
            self.p_spec.addItem(self.label3)
            self.label3.setPos(0,SpecRange/2+offset)

            self.label4 = pg.TextItem(text=str(3*FreqRange//4000), color='g', anchor=(0,0))
            self.p_spec.addItem(self.label4)
            self.label4.setPos(0,3*SpecRange/4+offset)

            self.label5 = pg.TextItem(text=str(FreqRange//1000), color='g', anchor=(0,0))

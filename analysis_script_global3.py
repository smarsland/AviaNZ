...
test_analysis_dir = "C:\\Users\\Virginia\\Documents\\Work\\Thesis_images\\Chapter_4\\TFR"
method_number = 6

start_index = 5
test_list0 = []
for i in range(method_number):
    test_list0.append('Test_' + str(start_index + i*30))
...
boxprops = dict(color='midnightblue')
flierprops = dict(markeredgecolor='midnightblue')
...
boxprops = dict(color='mediumblue')
flierprops = dict(markeredgecolor='mediumblue')
whiskerprops = dict(color='mediumblue')
capprops = dict(color='mediumblue')
medianprops = dict(color='darkorange')
median_color = 'orange'
